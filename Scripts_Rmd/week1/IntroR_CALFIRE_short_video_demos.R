...
# to clear environments you can type in the following
# rm(list = ls())
...
str(data)
glimpse(data)
typeof(data$Total_Acres_Burned) # single columns can be reffered to using '$'
...
#### Basic data warngling (dplyr functions) ####
