...
Convert date and time column values from characters to dates, add columns with time elapsed for each experiment, and convert cells/mml to cells/l, subset data to select only VOI & drop na's 
...
- Doubling time as ln(2) divided by the specific growht rate
...
We'll apply the average carbon content of bacterioplankton cells from Coastal Japan (~30 fg C cells^-1^)
